  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <button
        ...
        className="flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-full shadow-[0_4px_15px_rgba(0,0,0,0.2)] hover:bg-[#128C7E] transition-all active:scale-95 group border-2 border-white/20"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
