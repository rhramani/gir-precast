  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[100] flex flex-col items-end gap-2 sm:gap-3">
      ...
      <button
        ...
        className="flex items-center gap-2 bg-[#25D366] text-white p-3 sm:px-6 sm:py-3 rounded-full shadow-[0_4px_15px_rgba(0,0,0,0.2)] hover:bg-[#128C7E] transition-all active:scale-95 group border-2 border-white/20"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
