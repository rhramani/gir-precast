...
const NotFound = () => {
  ...
  return (
    <div className="min-h-[600px] flex items-center justify-center bg-gradient-to-br from-gir-dark-blue/5 to-gir-gold/5">
      <div className="text-center max-w-lg px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/"
            className="px-8 py-3 bg-gir-gold text-gir-dark-blue rounded-lg font-bold hover:bg-gir-gold/90 transition-all btn-premium"
          >
            Return to Home
          </Link>
          <Link
